 ...
 */
class LoginActivityConecta4 : AppCompatActivity(), LoaderCallbacks<Cursor> {
    /**
     * Keep track of the login task to ensure we can cancel it if requested.
     */
    private var mAuthTask: UserLoginTask? = null
    private fun AttemptConecta4(type: String) {
        SettingsActivityConecta4.setLocal(this@LoginActivityConecta4, switch_local.isChecked)
        ...
        val loginRegisterCallback = object : RoundRepository.LoginRegisterCallback {
            override fun onLogin(playerUuid: String) {
                SettingsActivityConecta4.setPlayerUUID(this@LoginActivityConecta4, playerUuid)
                SettingsActivityConecta4.setPlayerName(this@LoginActivityConecta4, email.text.toString())
                val prueba1 = SettingsActivityConecta4.getPlayerName(this@LoginActivityConecta4)
                val prueba2 = SettingsActivityConecta4.getPlayerUUID(this@LoginActivityConecta4)
                startActivity(
                    Intent(this@LoginActivityConecta4,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_loginconecta4)
